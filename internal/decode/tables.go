...
// EBCDIC codepage tables not shipped by golang.org/x/text/encoding/charmap.
//
// Generated from glibc iconv (iconv -f IBM277 / IBM1142 -t UTF-32LE over
// bytes 0x00-0xFF). CP277 is the Denmark/Norway EBCDIC page; CP1142 is
// CP277 with the euro sign replacing the currency sign at 0x5A.

// tableCP277: IBM-277 (EBCDIC Denmark/Norway).
var tableCP277 = [256]rune{
...
// tableCP1142: IBM-1142 (EBCDIC Denmark/Norway with euro).
var tableCP1142 = func() [256]rune {
	table := tableCP277
	table[0x5A] = '€'
	return table
}()
